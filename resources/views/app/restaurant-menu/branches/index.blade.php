...
<div class="card content-card mb-4">
    <div class="card-body p-4">
        <form method="GET" action="{{ route('app.restaurant-menu.branches.index', $workspace) }}" class="row g-3 align-items-end">
            <div class="col-md-6">
            ...
            <div class="col-md-3 d-flex gap-2">
                ...
                <a href="{{ route('app.restaurant-menu.branches.index', $workspace) }}" class="btn btn-outline-secondary">
                    إعادة ضبط
                </a>
            </div>
        </form>
                ...
                <tbody>
                    @forelse($branches as $branch)
                        <tr>
                            ...
                            <td>
                                <a
                                    href="{{ route('public.restaurant-menu.branch', [$workspace, $branch]) }}"
                                    target="_blank"
                            ...
                            <td>
                                <div class="d-flex justify-content-end gap-2">
                                    <a
                                        href="{{ route('app.restaurant-menu.branches.edit', [$workspace, $branch]) }}"
