...
<head>
    ...
    <meta name="description"
        content="أنشئ صفحة بزنس ذكية لعرض روابطك ومنتجاتك وخدماتك واستقبال الطلبات والحجوزات عبر واتساب من رابط واحد.">
    <meta name="keywords"
        content="صفحة بزنس, ديجيتال بايو, واتساب, كتالوج منتجات, حجز مواعيد, CRM, روابط السوشيال, صفحة ذكية">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="landingNavbar">
                        <ul class="navbar-nav mx-auto gap-lg-3 py-3 py-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link nav-link-clean" href="affiliate">التسويق بالعمولة</a>
                            </li>
                        </ul>
                        ...
                        <div class="d-flex gap-2 flex-column flex-lg-row">
                            @auth
                                @php
                                    $firstWorkspace = auth()->user()->ownedWorkspaces()->latest('id')->first();
                                @endphp

                                @if ($firstWorkspace)
                                    <a href="{{ route('app.business-profile.edit', $firstWorkspace) }}"
                                        class="btn btn-sb-light">
                                        لوحة التحكم
                                    </a>
                                @else
            ...
            <section class="hero-section">
                <div class="container text-center">
                    ...
                    <p class="hero-subtitle">
                        اعرض بيانات نشاطك، روابط السوشيال، الكتالوج، الخدمات، واستقبل طلبات واتساب وحجوزات العملاء من
                        رابط واحد مناسب للموبايل.
                    </p>
                        ...
                        <div class="preview-card">
                            ...
                            <div class="preview-body">
                                ...
                                <div class="preview-copy">
                                    ...
                                    <p>
                                        هذا التصميم هو الأساس فقط. الأقسام التفصيلية مثل المميزات، طريقة العمل، الأسعار،
                                        الأسئلة الشائعة، وتجارب العملاء سيتم إضافتها كأقسام مستقلة لاحقًا.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="cta-strip">
                        <div class="row align-items-center g-4">
                            <div class="col-lg-8">
                                ...
                                <p>
                                    يمكنك البدء بروابطك وبياناتك الأساسية، ثم إضافة المنتجات، الخدمات، الحجوزات،
                                    والعملاء لاحقًا.
                                </p>
                            </div>
            ...
            <section id="how-it-works" class="section-placeholder pt-0">
                <div class="container">
                    <div class="section-heading">
                        ...
                        <p class="section-description">
                            لا تحتاج موقع كامل أو إعدادات معقدة. جهّز صفحة البزنس، شارك الرابط، واستقبل الطلبات أو
                            الحجوزات.
                        </p>
                    </div>
                    ...
                    <div class="row g-4 how-steps-row">
                        ...
                        <div class="col-lg-4">
                            <div class="how-card">
                                ...
                                <p>
                                    ضع الرابط في البايو أو الإعلانات أو الرسائل، واجعل العملاء يتواصلون أو يحجزون
                                    مباشرة.
                                </p>
                    ...
                    <div class="mobile-note-card mt-4 mt-lg-5">
                        <div class="row align-items-center g-4">
                            <div class="col-lg-7">
                                ...
                                <p>
                                    أغلب العملاء يفتحون الرابط من واتساب أو انستجرام أو فيسبوك، لذلك الصفحة خفيفة وسريعة
                                    وواضحة على شاشة الموبايل.
                                </p>
                            </div>
                    ...
                    <div class="faq-wrapper" id="faqAccordion">
                        <div class="faq-item">
                            ...
                            <div id="faqOne" class="collapse show" data-bs-parent="#faqAccordion">
                                <div class="faq-body">
                                    لا. الفكرة أن تبدأ بصفحة بزنس ذكية وسريعة تجمع بياناتك وروابطك ومنتجاتك وحجوزاتك في
                                    رابط واحد، بدون تعقيد موقع كامل.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="faq-item">
                            ...
                            <div id="faqTwo" class="collapse" data-bs-parent="#faqAccordion">
                                <div class="faq-body">
                                    نعم. التصميم مبني أساسًا للموبايل لأن أغلب العملاء يفتحون الروابط من واتساب،
                                    إنستجرام، فيسبوك، أو الإعلانات.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="faq-item">
                            ...
                            <div id="faqThree" class="collapse" data-bs-parent="#faqAccordion">
                                <div class="faq-body">
                                    نعم. يمكنك إضافة منتجات أو خدمات مع صور وأسعار وتصنيفات، ويظهر لكل منتج أو خدمة زر
                                    تواصل أو طلب عبر واتساب.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="faq-item">
                            ...
                            <div id="faqFour" class="collapse" data-bs-parent="#faqAccordion">
                                <div class="faq-body">
                                    نعم. يمكنك تفعيل الحجز، تحديد أيام وساعات العمل، واستقبال طلبات الحجز من الصفحة
                                    العامة، ثم إدارة المواعيد من لوحة التحكم.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="faq-item">
                            ...
                            <div id="faqFive" class="collapse" data-bs-parent="#faqAccordion">
                                <div class="faq-body">
                                    المنصة تستخدم روابط واتساب مباشرة لفتح محادثة برسالة جاهزة. ويمكن لاحقًا تطوير
                                    التكامل مع WhatsApp Business API حسب احتياج الباقة.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="faq-item">
                            ...
                            <div id="faqSix" class="collapse" data-bs-parent="#faqAccordion">
                                <div class="faq-body">
                                    نعم. لوحة التحكم تحتوي على CRM مبسط للعملاء، مواعيدهم، ومصادرهم، بالإضافة إلى تتبع
                                    الضغطات على واتساب والروابط والمنتجات.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="faq-item">
                            ...
                            <div id="faqSeven" class="collapse" data-bs-parent="#faqAccordion">
                                <div class="faq-body">
                                    نعم. يمكنك البدء بباقة مجانية أو تجربة محدودة، ثم الترقية لاحقًا عندما تحتاج منتجات
                                    أكثر، حجوزات، أو إمكانيات CRM أكبر.
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="section-placeholder pt-0">
                <div class="container">
                    <div class="final-cta">
                        ...
                        <p>
                            لا تنتظر موقع كامل أو إعدادات معقدة. ابدأ بصفحة بسيطة، ثم أضف المنتجات والحجوزات والعملاء
                            خطوة بخطوة.
                        </p>
