{{-- resources/views/public/restaurant-menu/templates/sections/item-modal/bottom-sheet.blade.php --}}
<div class="modal fade item-bottom-sheet-modal" id="itemModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-bottom">
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                ...
                <div class="bottom-sheet-price mb-3">
                    <div>
